...
├── Daily_Steps_Tracker.py
├── Employee_Salary_Analysis.py
├── Feature_Relationship_Analysis.py
├── Height_vs_Weight_plot.py
├── Holi_Color_Sales_Analysis_Project.py
├── Holi_Sales_Analysis.py
├── Mobile_Phone_Price_Analysis.py
├── Population_Growth_Comparison.py
├── Salary_Analysis_by_Experience.py
├── Simple_Expense_Chart.py
├── Student_Academic_Dashboard.py
├── Student_Performance_Analytics_Dashboard_using_Matplotlib.py
├── Weekly_temp_Analysis.py
├── Wine_quantity.py
